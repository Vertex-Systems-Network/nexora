...
| Legacy alias | Historical meaning | Canonical stable stage |
|---|---|---|
...
| N1.8 | Forms / Data / Workflows | currently represented by approved master stages and existing automation closure; do not infer scope without checking the master plan |
| N1.9 | Marketplace | `MARKETPLACE-CLOSURE-001` |
| N1.10 | Commerce 2.0 | `COMMERCE-CLOSURE-001` for existing foundation, then `COMMERCE-200` for approved 2.0 work |
| N1.11 | CRM / Membership / Customer Portal | `CRM-MEMBERSHIP-HELPDESK-CLOSURE-001` then `PORTAL-200` |
| N1.12 | Search 2.0 | `SEARCH-200` |
| N1.13 | Collaboration | `COLLAB-200` |
| N1.14 | Automation | `AUTOMATION-CLOSURE-001`; no separate master N1.14 automation stage exists |
| N1.15 | AI Platform Capabilities | `AI-PLATFORM-100` |
| N1.16 | Multisite / Organizations | existing `ENTERPRISE-CLOUD-CLOSURE-001`; future enterprise expansion `ENTERPRISE-GOV-200` |
| N1.17 | SSO / Enterprise Governance | existing `ENTERPRISE-CLOUD-CLOSURE-001`; future `ENTERPRISE-GOV-200` |
| N1.18 | Public APIs / Webhooks / SDK | `API-PLATFORM-100` plus `DX-200` |
| N1.19 | Import / Export / WordPress migrations | `MIGRATION-CENTER-100` plus `CONFIG-AS-CODE-100` |
| N1.20 | Observability | `OBSERVABILITY-200` |
| N1.21 | Developer Experience / Forge | `DX-200` |
| N1.22 | Sentinel 2.0 | `SENTINEL-200` |
| N1.23 | Marketplace 2.0 | `MARKETPLACE-200` |
| N1.24 | Cloud / HA / Distributed Runtime | existing `ENTERPRISE-CLOUD-CLOSURE-001`; final evidence `RELEASE-CERT-100` |
| N1.25 | Backup / DR / Upgrade Certification | `DR-PLATFORM-100` then `RELEASE-CERT-100` |
| N1.26 | Performance + Accessibility + Release | `A11Y-CERT-100`, `PERF-CWV-CERT-100`, `RELEASE-CERT-100` |

## Legacy master-plan aliases

Source: `docs/NEXORA_PLAN_STATUS.md`.

| Legacy alias | Master-plan meaning | Canonical stable stage |
|---|---|---|
...
| N1.15 | Nexora AI Platform / Agents | `AI-PLATFORM-100` |
