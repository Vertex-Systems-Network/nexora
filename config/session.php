...
return [
    ...
    */
    ...
    'driver' => $nexoraInstallPending ? 'file' : env('SESSION_DRIVER', 'database'),
    ...
    */
    ...
    'encrypt' => filter_var(env('SESSION_ENCRYPT', true), FILTER_VALIDATE_BOOL),
    ...
    */
    ...
    'secure' => filter_var(env('SESSION_SECURE_COOKIE', str_starts_with((string) env('APP_URL', ''), 'https://')), FILTER_VALIDATE_BOOL),
