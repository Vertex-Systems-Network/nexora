...
final class AutomationTriggerRegistry
{
    ...
    public function __construct()
    {
        foreach ([
            ...
            ['key'=>'form.submitted','label'=>'Form submitted','group'=>'Forms','description'=>'Runs after a validated Nexora form response is stored.','fields'=>['form.id','form.uuid','form.slug','form.name','submission.id','submission.uuid','submission.user_id','submission.values']],
